  ...
  return (
    <section className="animate-in fade-in-50 duration-200">
      ...
      <div className="space-y-6">
        ...
        {showResetBanner && (
          <Alert className="border-amber-300 bg-amber-50 dark:border-amber-600/40 dark:bg-amber-950/40">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <AlertDescription className="text-amber-900/80 dark:text-amber-100/80 text-sm">
                  {statusMessage}
                </AlertDescription>
                <Button
                  onClick={handleReset}
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {config && (
            <Button
              ...
              onClick={handleReset}
              disabled={resetting}
              className="border-red-300 text-red-600 hover:bg-red-50 hover:text-red-700 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950/40 dark:hover:text-red-300"
            >
              {resetting ? (
                <>
                  <Loader2 className="size-4 animate-spin" />
